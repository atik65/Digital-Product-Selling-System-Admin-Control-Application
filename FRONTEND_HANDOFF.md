...
1. **Category Filter**: `GET /api/v1/products?category_id=1&page=1&size=12`
2. **Product Page**: `GET /api/v1/products/{slug}` returns packages and dynamic fields together.
3. **Packages**: Each package represents a purchase tier (e.g. `115 Diamonds - ৳85`, `610 Diamonds - ৳430`).
